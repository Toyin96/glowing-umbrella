...
namespace LegalSearch.Infrastructure.Services.User
{
    public class UserSetupService : IUserSetupService
    {
        ...
        public UserSetupService(AppDbContext dbContext, ISessionService sessionService, ILogger<UserSetupService> logger, UserManager<LegalSearch.Domain.Entities.User.User> userManager)
        {
