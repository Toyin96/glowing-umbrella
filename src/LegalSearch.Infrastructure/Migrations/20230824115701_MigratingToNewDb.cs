        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityTable = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionStan = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TransferAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PaymentResponseMetadata = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnlockCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UnlockCodeExpiration = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaffId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RequestInitiator = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    LienId = table.Column<string>(type: "nvarchar(max)", nullable: true),
